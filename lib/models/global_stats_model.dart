...
//
//     final globalStatsModel = globalStatsModelFromJson(jsonString);

import 'dart:convert';

GlobalStatsModel globalStatsModelFromJson(String str) => GlobalStatsModel.fromJson(json.decode(str));

String globalStatsModelToJson(GlobalStatsModel data) => json.encode(data.toJson());
...
class GlobalStatsModel {
  ...
  factory GlobalStatsModel.fromJson(Map<String, dynamic> json) => GlobalStatsModel(
